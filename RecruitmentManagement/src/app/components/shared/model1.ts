export const Experiance = [' 0 to 2 Year', ' 2 to 4 Year', ' 4 to 6 Year', ' 6 to 12 Year'];
export const Budget = ['2.4 to 4.8 Lac', '4.8 to 9.6 Lac', '9.6 to 9.8 Lac'];
export const isNp = ['Yes', 'No'];
